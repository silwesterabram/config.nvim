...
do
  ...
  -- Set tab spaces to be 4 characters
  vim.o.tabstop = 4
  vim.o.shiftwidth = 4
  vim.o.softtabstop = 4
...
do
  ...
  vim.keymap.set('n', '<left>', '<cmd>echo "Arrows are not mapped. Use h to move left"<CR>')
  vim.keymap.set('n', '<right>', '<cmd>echo "Arrows are not mapped. Use l to move right"<CR>')
  vim.keymap.set('n', '<up>', '<cmd>echo "Arrows are not mapped. Use k to move up"<CR>')
  vim.keymap.set('n', '<down>', '<cmd>echo "Arrows are not mapped. Use j to move down"<CR>')
